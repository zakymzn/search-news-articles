  ...
  return (
    <div>
      <nav className='top-0 sticky z-[999] w-full bg-white flex justify-between items-center px-8'>
        ...
        <form onSubmit={handleSearchArticle} className='bg-gray-100 w-full lg:w-1/3 flex items-center rounded-full px-4 py-2 m-4'>
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z" /></svg>
          <input type="text" placeholder='Search news articles' value={query} onChange={(e) => setQuery(e.target.value)} className='w-full px-4 py-2 focus:outline-none' />
        </form>
        <div></div>
      </nav>

      <div className='p-4 xl:px-64'>
        {
      ...
      <footer className='border-t border-gray-200'>
        <p className="py-4 text-center">
          © {new Date().getFullYear()} by Ma'mur Zaky Nurrokhman
        </p>
      </footer>
